...
exports.seed = async function (knex) {
  ...
  await knex('products').insert([
    ...
    { product_picture: '../../assets/stores/products/KemejaFlannelILenganPanjangKotak(Button-Down).jpg', product_name: 'Sweater Souffle Yarn Kerah Bulat', category: 'WOMEN', price: '399000', stock: '100', size: 'S', description: 'Kode Produk: 472294' },
